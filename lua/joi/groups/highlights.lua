...
function M.highlight(palette, opts)
	return {
		...
		NormalFloat = { bg = palette.bg_2 },
		NormalNC = { fg = palette.fg_0, bg = palette.bg_0 },
		Number = { fg = palette.gold },
		Operator = { fg = palette.red },
		Pmenu = { fg = palette.fg_1, bg = palette.bg_2 },
		PmenuSbar = { bg = palette.bg_2 },
		PmenuSel = { fg = palette.bg_2, bg = palette.gold },
		PmenuThumb = { bg = palette.fg_1 },
		...
		Visual = { fg = palette.bg_0, bg = palette.fg_2 },
		VisualNOS = { bg = palette.bg_2 },
		WarningMsg = { fg = palette.error, bg = palette.bg_0 },
		Whitespace = { fg = palette.fg_2 },
