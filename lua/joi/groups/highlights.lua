...
function M.highlight(palette, opts)
	return {
		...
		diffAdded = { fg = palette.turquoise, bg = palette.diffAdded },
		diffChanged = { fg = palette.blue, bg = palette.diffChanged },
		diffRemoved = { fg = palette.red, bg = palette.diffRemoved },
