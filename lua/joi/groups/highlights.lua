...
function M.highlight(palette, opts)
	return {
		...
		Function = vim.tbl_extend("force", { fg = palette.fg }, opts.styles.functions),
		Identifier = { fg = palette.fg },
		Ignore = { fg = palette.fg, bg = palette.alt_bg, bold = true },
		IncSearch = { fg = palette.bg, bg = palette.lemongrass }, -- fg should surely be p.bg?
		...
		TabLineFill = { fg = palette.fg, bg = palette.accent },
		TabLineSel = { fg = palette.fg, bg = palette.accent },
